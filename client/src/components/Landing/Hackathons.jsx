...
const Hackathons = () => {
  return (
    <>
      <Helmet>
        <title>Hackathons | Prompt The Future</title>
        <meta
          name="description"
          content="Únete a los Hackathons de Prompt The Future y participa en eventos tecnológicos emocionantes. Aprende a construir aplicaciones con GPT-4 y colabora con líderes de la industria en un entorno remoto y estimulante."
        />
        <meta
          name="keywords"
          content="Hackathons, Prompt The Future, GPT-4, eventos tecnológicos, aplicaciones IA, colaboración tecnológica, Hackathon remoto, Buenos Aires Tech Week"
        />
      </Helmet>
      <Container
        component={"section"}
        ...
        >
          ...
          >
            ...
            <Typography sx={{ color: "primary.main" }} variant="body2">
              Cree aplicaciones notables con comprensión avanzada de audio,
              visión y texto con el nuevo GPT-4o.
            </Typography>
            <Box>
              <Stack
                direction="row"
