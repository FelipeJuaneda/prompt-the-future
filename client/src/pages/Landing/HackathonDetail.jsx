    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Box sx={{ width: { xs: "100%", md: "75%" }, my: 4 }}>
        <Typography
          ...
          color="secondary.main"
        >
          Buenos Aires Tech Week - AI Hackathon Build LLM Applications With GPTo
        </Typography>
        <Typography variant="h5" color="secondary.main">
          Cree aplicaciones notables con comprensión avanzada de audio, visión y
          texto con el nuevo GPT-4o.
        </Typography>
      ...
      >
        ...
        <Typography variant="subtitle1" sx={{ mb: 2, color: "#8627CC" }}>
          ...
          herramientas innovadoras basadas en modelos de lenguaje para diversas
          industrias.
        </Typography>
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ color: "secondary.main", mb: 2 }}>
          Nuestro hackathon es un evento diseñado para fomentar la creatividad,
          la innovación y la colaboración entre desarrolladores, ingenieros,
          diseñadores y entusiastas de la IA. Durante 3 días intensivos, los
          participantes trabajarán en equipos para desarrollar soluciones que
          aprovechen el poder de los modelos de lenguaje, con el objetivo de
          transformar industrias y resolver problemas del mundo real.
        </Typography>
        <Typography
          variant="h5"
          sx={{ fontWeight: "bold", color: "secondary.main", mb: 2 }}
        ...
        <Typography variant="body1" sx={{ color: "secondary.main" }}>
          ...
          desafíos centrados en diferentes sectores como la salud, la educación,
          el comercio, la finanza, y más. Cada equipo deberá desarrollar una
          herramienta o aplicación que utilice modelos de lenguaje para abordar
          problemas específicos y presentar soluciones viables y creativas.
        </Typography>
      </Box>
      ...
      >
        ...
        >
          ...
          <Typography variant="body1" sx={{ color: "secondary.main" }}>
            ...
            Gana visibilidad y reconocimiento en una de las semanas tecnológicas
      ...
      <Box sx={{ my: 4 }}>
        ...
        >
          ...
          simplemente alguien con ideas innovadoras, este hackathon es para ti.
        </Typography>
        <Typography
          variant="h5"
        ...
        <ol style={{ padding: 0, marginLeft: "1rem" }}>
          ...
          <li style={{ color: "white" }}>
            <Typography variant="body1" sx={{ color: "secondary.main", mb: 2 }}>
              ...
              Todo el Hackathon se va a estar haciendo por el servidor de PTF en
              Discord.
            </Typography>
          </li>
          <li style={{ color: "white" }}>
        ...
        <Typography variant="body1" sx={{ color: "secondary.main", mb: 2 }}>
          No pierdas la oportunidad de unirte a la revolución de la Inteligencia
          artificial!
        </Typography>
